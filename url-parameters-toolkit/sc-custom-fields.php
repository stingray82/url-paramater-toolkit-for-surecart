     ...
     *   - Adds admin inline JavaScript that fixes edit/cancel buttons and cleans the URL.
     ...
     * Note: Instead of asking for a full CSS selector, we now only ask for the SC-Input's name attribute value.
     */
    function sccf_render_custom_fields_admin_ui() {
        if ( isset($_GET['page']) && $_GET['page'] === 'sc-url-parms' && isset($_GET['tab']) && $_GET['tab'] === 'custom_fields' ) {
            ...
            if ( isset($_POST['add_custom_field']) ) {
                ...
                // Here we only capture the SC-Input name value.
            ...
            <div class="wrap">
                ...
                <p>Map a URL parameter key to an SC-Input’s <strong>name</strong> attribute value.
                    The plugin will build a valid selector (sc-input[name="..."]) for you.</p>
